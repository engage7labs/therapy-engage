...
export function CriticalAudioAlerts({ onNavigateToSession, onAcknowledgeAlert }: CriticalAudioAlertsProps) {
  ...
  // Handle repeat alerts for critical/urgent alerts
  const setupRepeatAlert = useCallback((alert: CriticalAlert) => {
    let repeatCount = 0
  ...
  }, [criticalAlerts, alertSettings, playAlertSound, setupRepeatAlert])
