...
export default function AcademicEvaluationTools() {
  ...
  const evaluationCriteria: EvaluationCriteria[] = [
    // User Experience & Interface
    {
      ...
      description:
        "Platform provides clear, intuitive navigation for both therapists and patients",
      weight: 15,
      score: 14,
      maxScore: 15,
      status: "completed",
    ...
    },
    {
      ...
      description:
        "Interface adapts seamlessly across desktop, tablet, and mobile devices",
      weight: 10,
      score: 9,
      maxScore: 10,
      status: "completed",
    ...
    // Clinical Functionality
    {
      ...
      description:
        "Comprehensive tools for scheduling, conducting, and documenting therapy sessions",
      weight: 20,
      score: 18,
      maxScore: 20,
      status: "completed",
    ...
    },
    {
      ...
      description:
        "Robust system for monitoring and analyzing patient progress over time",
      weight: 15,
      status: "in-progress",
      maxScore: 15,
    ...
    },
    {
      ...
      description:
        "Emergency protocols and crisis intervention features for patient safety",
      weight: 10,
      status: "pending",
      maxScore: 10,
      evidence: [],
    ...
    // Technical Implementation
    {
      ...
      description:
        "Platform demonstrates optimal loading times and responsive performance",
      weight: 10,
      score: 9,
      maxScore: 10,
      status: "completed",
    ...
    // Security & Compliance
    {
      ...
      description:
        "Implementation of comprehensive data protection and privacy measures",
      weight: 20,
      status: "in-progress",
      maxScore: 20,
    ...
    },
    {
      ...
      description:
        "Healthcare data handling meets HIPAA security and privacy requirements",
      weight: 15,
      status: "pending",
      maxScore: 15,
      evidence: [],
  ...
  const calculateCategoryScore = (categoryName: string) => {
    ...
    const completedCriteria = categoryCriteria.filter(
      (c) => c.score !== undefined
    );

    if (completedCriteria.length === 0) return 0;

    const totalScore = completedCriteria.reduce(
      (sum, c) => sum + (c.score || 0),
      0
    );
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-muted-foreground">
            Comprehensive evaluation framework for academic assessment and
            project grading
          </p>
        </CardHeader>
        <CardContent>
          <div className="grid gap-4 md:grid-cols-4">
            ...
            <div className="text-center">
              <p className="text-2xl font-bold">
                {criteria.filter((c) => c.status === "completed").length}
              </p>
            ...
            <div className="text-center">
              <p className="text-2xl font-bold">
                {criteria.filter((c) => c.status === "in-progress").length}
              </p>
            ...
            <div className="text-center">
              <p className="text-2xl font-bold">
                {
                  evaluationReports.filter((r) => r.status === "reviewed")
                    .length
                }
              </p>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg">
                  ...
                  <div>
                    <p className="font-medium">
                      System Performance Evaluation Completed
                    </p>
                    <p className="text-sm text-muted-foreground">
                      Scored 9/10 points
                    </p>
                ...
                <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                  ...
                  <div>
                    <p className="font-medium">
                      Technical Architecture Assessment Reviewed
                    </p>
                    <p className="text-sm text-muted-foreground">
                      Dr. Sarah Mitchell provided feedback
                    </p>
                  </div>
                </div>
